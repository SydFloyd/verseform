...
- The uploaded artifact is `verseform-0.1.0-windows-alpha`, retained through 2026-09-17. Its exact clean-runner installer—the upgrade baseline used by the verified 0.2.0 workflow—is 4,197,262 bytes with SHA-256 `0caebf685ed7debfbb164b32a807871fb5d94026c471e1c03f23d2b025544001`. `VFM-160` archives those bytes and their provenance as a non-latest [`v0.1.0` pre-release](https://github.com/SydFloyd/verseform/releases/tag/v0.1.0), so patch verification no longer depends on Actions retention. The distinct locally verified refined installer remains 4,195,936 bytes with SHA-256 `5B637F9CF98380186B79DA60AD1ED5B51EEDCDA14A491F5476E07EEDC985B050`; both installers are unsigned.
