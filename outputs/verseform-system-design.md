...
| Shell | A passive web document bar supplies name/save status, portable download, Windows download, and brief usage/storage/output help. Tab titles and beforeunload stay behind browser ports; key commands retain shared semantics. No account, cloud writing storage, mobile support, remote control, analytics, or production diagnostics are added. |
